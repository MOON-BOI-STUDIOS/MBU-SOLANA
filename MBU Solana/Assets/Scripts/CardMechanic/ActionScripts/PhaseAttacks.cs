...
public class PhaseAttacks : MonoBehaviour
{
    ...
    public virtual void PhaseOptions(MultiPlayerManager Selector, MultiPlayerManager OtherPlayer, bool bothPhases)
    {
    ...
    [PunRPC]
    public void InflictDamage(MultiPlayerManager OtherPlayer, int damage)
    {
